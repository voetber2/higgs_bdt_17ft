...
int main(){
  ...
  TFile* out_root = new TFile("TrainingResults_Grad_pt100.root", "RECREATE"); 
  
  ofstream out_txt; 
  out_txt.open("classified_events_pt100.txt");
  ...
  TString w = "/msu/data/t3work9/voetberg/bdt_tmva_outputs/data_pt100/weights/TMVAClassification_BDT_pt100.weights.xml"; 
  ...
  //Read data 
  TFile* in = TFile::Open("/msu/data/t3work9/voetberg/tmva_input/data_17feat_pt100.root"); 
  TFile* in2 = TFile::Open("/msu/data/t3work9/voetberg/tmva_input/data_17feat_pt100_reader.root"); 
