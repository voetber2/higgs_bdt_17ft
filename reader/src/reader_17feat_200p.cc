...
int main(){
  ...
  TFile* out_root = new TFile("TrainingResults_Grad_pt200p.root", "RECREATE"); 
  cout<<""<<endl; 
  
  ofstream out_txt; 
  out_txt.open("classified_events_pt200p.txt");
  ...
  TString w = "/msu/data/t3work9/voetberg/bdt_tmva_outputs/data_pt200p/weights/TMVAClassification_BDT_pt200p.weights.xml"; 
  ...
  //Read data 
  TFile* in = TFile::Open("/msu/data/t3work9/voetberg/tmva_input/data_17feat_pt200p.root"); 
  TFile* in2 = TFile::Open("/msu/data/t3work9/voetberg/tmva_input/data_17feat_pt200p_reader.root"); 
